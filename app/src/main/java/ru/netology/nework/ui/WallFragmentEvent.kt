...
import ru.netology.nework.databinding.FragmentWallEventBinding
import ru.netology.nework.dto.Event
import ru.netology.nework.viewmodel.EventViewModel
import ru.netology.nework.viewmodel.WallEventViewModel
import ru.netology.nework.viewmodel.UserViewModel

@ExperimentalCoroutinesApi
@AndroidEntryPoint
class WallFragmentEvent : Fragment() {

    private val eventViewModel by activityViewModels<EventViewModel>()
    private val authViewModel by activityViewModels<AuthViewModel>()
    private val userViewModel by activityViewModels<UserViewModel>()
    private val wallEventViewModel by activityViewModels<WallEventViewModel> ()
    ...
    override fun onCreateView(
        ...
        val binding = FragmentWallEventBinding.inflate(
            inflater,
            container,
            false
        )
        ...
        lifecycleScope.launchWhenCreated {
            if (id != null){
                wallEventViewModel.loadUserWallEvent(id).collectLatest (adapter::submitData)
            }
        }
